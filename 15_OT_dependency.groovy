...
/*
  The getUserData function fetches additional data for a user based on the specified type 
  (e.g., 'get_user_address', 'get_user_job').
  It constructs a JSON payload with the user data, sets up message headers, and sends a request to an external service.
  The response is parsed and returned as a Groovy object.
*/
